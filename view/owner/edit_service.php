...
<!-- MAIN CONTENT-->
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Price</label>
                                            <input class="form-control col-sm-5" type="number" step="0.01" name="serv_price" ng-model="serv_price" ng-value="service_price">
                                    </div>
    ...
    <script src="js_controller/get_edit_service.js"></script>
</body>
</html>
<!-- end document-->