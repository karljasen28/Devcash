...
<body class="animsition">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <a href="add_category.php"><button class="btn" style="background-color: #ec4e20;color: white;">Create Category</button></a>
                                </div>
                            </div>
                        </div><br>
                        <div class="row">
                        ...
                        <input type="text" ng-model="search" class="form-control col-sm-3" placeholder="Search.."><br>
                            <table class="table table-light table-hover dt-responsive">
                                ...
                                <tbody>
                                    <tr ng-repeat="cat in categories.slice().reverse() | filter:search">
                                        <td></td>
                                        <td>{{cat.category_name}}</td>
                                        <td>
                                            <a href="edit_category.php?id={{cat.id}}" class="btn btn-primary">Edit</a>
                                            <button class="btn btn-danger" ng-click="removeCategory(cat)">Delete</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <script src="js_controller/getcategory.js"></script>
