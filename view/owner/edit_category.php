...
<body>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap" style="border-bottom: 3px solid #ec4e20;">
                                    <h3 class="title-1">Update Category Info</h3>
                                </div>

                                <div class="row">
                                    <div class="container" ng-controller="EditCategory">
                                        <form class="form-horizontal" name="drop_list" id="f1" method="POST">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Category Name</label>
                                                    <input class="form-control col-sm-5" type="text" ng-value="cat_name" ng-model="edit_catname">
                                            </div>    

                                            <div class="form-group">
                                                <input class="btn col-sm-2" type="submit" name="" value="Update" style="background-color: #ec4e20;color: white;" ng-click="editCategory()">
                                                <a class="btn btn-danger col-sm-2" href="#" ng-click="back()">Cancel</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
    ...
    <script src="js_controller/get_edit_category.js"></script>
</body>
</html>
<!-- end document-->