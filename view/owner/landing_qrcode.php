                        ...
                        <ul class="list-unstyled navbar__list">
                            ...
                            <li class="active has-sub">
                                ...
                                <ul class="list-unstyled navbar__sub-list js-sub-list">
                                    ...
                                    <li>
                                        <a href="landing_qrcode.php">
                                            <i class="fas fa-qrcode"></i>Discount</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="has-sub">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">QR Code List</h2>
                                    <!-- <button class="btn" style="background-color: #ec4e20;color: white;">Export QR Code</button> -->
                                </div>
                            </div>
                        </div><br>
                        <div class="row">
                        <div class="container">
                        <div class="table-responsive" ng-controller="GetQrCode">    
                    ...
                    <div class="input-group margin-bottom-sm">                  
                       <input type="text" ng-model="search" id="search" class="form-control col-sm-3" placeholder="Search..."><span class="input-group-addon"><i class="fa fa-search"></i></span>
                            ...
                            <table class="table table-light table-hover dt-responsive">
                                ...
                                <tbody>
                                    <tr ng-repeat="qr in qrcodes.slice().reverse() | filter:search | filter:sortby">
                                        <!-- <td>
                                           <div id="code"></div> 
                                        </td>      -->                 
                                        <td><a href="view_qrcode.php?id={{qr.id}}">View QR Code</a></td>
                                        <td>{{qr.qr_code}}</td>
                                        <td>{{qr.qr_price}}</td>
                                        <td>{{qr.qr_category}}</td>
                                        <td>
                                            <button class="btn btn-danger" ng-click="removeQr(qr)">Delete</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
ref.orderByChild("business/owner_username")
    ...
    <!-- <script src="js_controller/get_qrcode.js"></script> -->
</body>
</html>
<!-- end document-->