...
<body class="animsition">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap" style="border-bottom: 3px solid #ec4e20;">
                                    <h3 class="title-1">Category Info</h3>
                                </div>
                            </div>
                        </div><!-- END OF ROW --><br>
                        <div class="row">
                                ...
                                <form class="form-horizontal" ng-submit="addCategory()">        
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Upload Image</label>
                                            <input class="form-control col-sm-4" type="file" name="emp_img" onchange="loadfile(event)" ng-model="cat_img">
                                    </div> -->

                                    <div class="form-group">
                                        <label class="control-label">Category Name</label>
                                            <input class="form-control col-sm-5" type="text" name="cat_name" ng-model="cat_name">
                                    </div>    

                                    <div class="form-group">
                                        <input class="btn col-sm-2" type="submit" name="add" value="Save" style="background-color: #ec4e20;color: white;">
                                        <a class="btn btn-danger col-sm-2" href="landing_category.php">Cancel</a></button>
                                    </div>
                                </form>
                                </div>
                            </div>
    ...
    <script src="js_controller/add_category.js"></script>
</body>
</html>
<!-- end document-->