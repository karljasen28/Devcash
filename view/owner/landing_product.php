...
<body class="animsition">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <a href="add_product.php"><button class="btn" style="background-color: #ec4e20;color: white;">Create Product</button></a>
                                </div>
                            </div>
                        </div><br>
        <div class="row">
            <div class="container">
               <div class="table-responsive" ng-controller="GetProduct">
                                ...
                                <tbody>
                                    <tr ng-repeat="prod in products.slice().reverse() | filter:search | filter:sortby">
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-danger" ng-click="removeProduct(prod)">Delete</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <script src="js_controller/getproduct.js"></script>
</body>
</html>
<!-- end document-->