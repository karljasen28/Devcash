...
<body>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Discount List</h2>
                                    <a href="add_discount.php"><button class="btn" style="background-color: #ec4e20;color: white;">Create Discount</button></a>
                                </div>
                            </div>
                        </div><br>
                        <div class="row">
                        <div class="container">
                        <div class="table-responsive" ng-controller="FormController">    
                        <input type="text" ng-model="search" placeholder="Search..." class="form-control col-sm-3"><br>    
                            <table class="table table-light table-hover dt-responsive">
                                ...
                                <tbody>
                                    <tr ng-repeat="disc in discounts.slice().reverse() | filter:serach">
                                        <td>{{disc.disc_code}}</td>
                                        <td>{{disc.disc_value}}</td>
                                        <td>{{disc.disc_status}}</td>
                                        <td>{{disc.disc_start}}</td>
                                        <td>{{disc.disc_end}}</td>
                                        <td>
                                            <a href="edit_discount.php?id={{disc.id}}" class="btn btn-primary">Edit</a>
                                            <button class="btn btn-danger" ng-click="removeDiscount(disc)">Delete</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <script src="js_controller/getdiscount.js"></script>
</body>
</html>
<!-- end document-->