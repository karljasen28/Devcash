...
<body class="animsition">
                    ...
                    <div class="row">
                        <div class="container">
                            <div class="overview-wrap" style="border-bottom: 3px solid #ec4e20;">
                                <h3 class="title-1">Update Profile</h3>
                            </div>
                        </div>
                    </div><br>
                    <div class="row" ng-controller="EditProfile">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm">Upload Image
                                        <input class="form-control col-sm-4" type="file" onchange="loadfile(event)" ng-model="profile">
                                    </label>
                                </div> -->
                                <div class="form-group">
                                    <label class="control-label col-sm-4">First Name
                                        <input class="form-control" type="text" ng-model="fname" ng-value="owner_fname">
                                    </label>
                                    <label class="control-label col-sm-4">Last Name
                                        <input class="form-control" type="text" ng-model="lname" ng-value="owner_lname">
                                    </label>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-4">Mobile No.
                                        <input class="form-control" type="text" ng-model="mobileno" ng-value="owner_mobileno">
                                    </label>
                                    <label class="control-label col-sm-3">Gender
                                        <select class="form-control" ng-model="gender">
                                            <option selected hidden disabled ng-value="owner_gender">{{owner_gender}}</option>
                                            <option>Male</option>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm">    
                                    <button class="btn" ng-click="editProfile()" style="background-color:#ec4e20;color: white; ">Update</button>
    ...
    <script src="js_controller/get_edit_profile.js"></script>
</body>
</html>
<!-- end document-->