...
<body>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap" style="border-bottom: 3px solid #ec4e20;">
                                    <h3 class="title-1">Update Discount Info</h3>
                                </div>
                            </div>
                        </div><!-- END OF ROW --><br>
                        <div class="row">
                            <div class="container" ng-controller="EditDiscount">
                                <form class="form-horizontal" name="drop_list" id="f1" method="POST">
                                    <div class="form-group">
                                        <label class="control-label">Discount Code</label>
                                            <input class="form-control col-sm-5" type="text" ng-model="edit_disccode"
                                            ng-value="disc_code">
                                    </div>           
                                            
                                    <div class="form-group">
                                        <label class="control-label">Amount Value</label>
                                            <input class="form-control col-sm-5" type="number" step="0.01" ng-model="edit_value" ng-value="disc_value">
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">Date Started</label>
                                            <input class="form-control col-sm-5" type="date" ng-model="edit_discstart" ng-value="disc_start">
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">Date End</label>
                                            <input class="form-control col-sm-5" type="date" ng-model="edit_discend"
                                            ng-value="disc_end">
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <input class="btn col-sm-2" type="submit" value="Update" style="background-color: #ec4e20;color: white;" ng-click="editDiscount()">
   ...
   <!--  <script>
    ...
    <script src="js_controller/get_edit_discount.js"></script>
</body>
</html>
<!-- end document-->