...
<body class="animsition">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap" style="border-bottom: 3px solid #ec4e20;">
                                    <h3 class="title-1">Service Info</h3>
                                </div>
                            </div>
                        </div><!-- END OF ROW --><br>
                        <div class="row">
                                ...
                                <form class="form-horizontal" ng-submit="addService()">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Upload Image</label>
                                            <input class="form-control col-sm-4" type="file" onchange="loadfile(event)" id="pic" ng-model="pic">
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">Service Name</label>
                                            <input class="form-control col-sm-5" type="text" name="serv_name" ng-model="serv_name">
                                    </div>    

                                    <div class="form-group">
                                        <label class="control-label" ng-model="prod_cat">Category</label>
                                            <select class="form-control  col-sm-5" name="serv_cat" ng-model="serv_cat">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Price</label>
                                            <input class="form-control col-sm-5" type="number" step="0.01" ng-model="serv_price">
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">Discount</label>
                                            <select name="serv_disc" class="form-control col-sm-5" ng-model="serv_disc">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-danger col-sm-2" href="landing_service.php">Cancel</a>
                                    </div>
                                </form>
                                </div>
                            </div>
    ...
    <script src="js_controller/add_service.js"></script>
</body>
</html>
<!-- end document-->