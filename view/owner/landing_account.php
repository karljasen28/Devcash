            ...
            <div class="main-content" ng-controller="GetUserLogin">
                <div class="section__content section__content--p30">
                    <div class="row">
                        <div class="container">
                            <div class="overview-wrap" style="border-bottom: 3px solid #ec4e20;">
                                <h3 class="title-1">My Profile</h3>
                            </div>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="container" style="background-color: #fefefe;"><br>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-5">First Name
                                    <input class="form-control" type="text" ng-model="fname" ng-value="owner_fname" disabled>
                                </label>
                                <label class="control-label col-sm-5">Last Name
                                    <input class="form-control" type="text" ng-model="lname" ng-value="owner_lname" disabled>
                                </label>
                            </div>
                            <div class="form-group">
                            <!--     <label class="control-label col-sm-5">Birthdate
                                    <input class="form-control" type="date" ng-model="bdate" ng-value="owner_bdate" disabled>
                                </label> -->
                                <label class="control-label col-sm-5">Mobile No.
                                    <input class="form-control" type="text" ng-model="mobileno" ng-value="owner_mobileno" disabled></label>
                                    
                                <label class="control-label col-sm-3">Gender
                                    <input class="form-control" type="text" ng-model="gender" ng-value="owner_gender" disabled>
                                </label>
                    ...
                    <div class="row">
                        <div class="container">
                            <div class="overview-wrap" style="border-bottom: 3px solid #ec4e20;">
                                <h3 class="title-1">My Account</h3>
                            </div><br>
                            <div class="row">
                                <div class="container" style="background-color: white;"><br><br>
                                    <div class="form-group">
                                        <label class="control-label col-sm-5">Email
                                            <input class="form-control" type="text" ng-model="email" ng-value="account_email" disabled>
                                        </label>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-5">Username
                                        <input class="form-control" type="text" ng-model="username" ng-value="account_username" disabled></label>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-5">Password
                                        <input class="form-control" type="password" ng-model="password" ng-value="account_password" id="pass" disabled>
                                    </label>
                                    </div>
                                    <div class="form-group">
                                        <label for="showPass" class="control-label col-sm-5">
                                        <input type="checkbox" id="showPass" onclick="showPass()">
                                        Show Password
                                        </label> 
                                    </div>
                                    <div class="form-group">
                                        <a class="col-sm-3" href="update_account.php?id={{accountid}}">Update Account</a>
                                    </div>
                                </div>
                            </div>
                        </div>
