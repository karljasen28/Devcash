                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Product Name</label>
                                            <input class="form-control col-sm-5" type="text" ng-model="prod_name" ng-value="name">
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">Product Brand</label>
                                            <input class="form-control col-sm-5" type="text" ng-model="prod_brand" ng-value="brand">
                                    </div>      

                                    <div class="form-group">
                                        <label class="control-label" ng-model="prod_cat">Category</label>
                                            <select class="form-control  col-sm-5" ng-model="prod_cat">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Unit of Measure</label>
                                            <select class="form-control col-sm-5" ng-model="prod_unit">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Unit Quantity</label>
                                            <input class="form-control col-sm-5" type="number" min="1" ng-model="prod_qty" ng-value="qty">
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">Expiration Date</label>
                                            <input class="form-control col-sm-5" type="date" name="prod_exp_date" ng-model="prod_exp_date" ng-value="exp">
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">Price</label>
                                            <input class="form-control col-sm-5" type="number" step="0.01" ng-model="prod_price" ng-value="price">
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">ROP</label>
                                            <input class="form-control col-sm-5" type="number" step="0.01" ng-model="prod_rop" ng-value="rop">
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">Discount Value</label>
                                            <select class="form-control col-sm-5" ng-model="prod_disc">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <button class="btn col-sm-2" type="submit" style="background-color: #ec4e20;color: white;" ng-click="editProduct()">Update</button>
                                        <a class="btn btn-danger col-sm-2" ng-click="back()" href="#">Cancel</a>
                                    </div>
                                </form>
                                </div>
                            </div>
...
<!--     <script>
 ...
 -->
    ...
    <script src="js_controller/get_edit_product.js"></script>
</body>
</html>
<!-- end document-->