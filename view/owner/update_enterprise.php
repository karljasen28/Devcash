...
<body class="animsition">
                    ...
                    <div class="row">
                        <div class="container">
                            <div class="overview-wrap" style="border-bottom: 3px solid #ec4e20;">
                                <h3 class="title-1">Update Enterprise</h3>
                            </div>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="container" style="background-color: #fefefe;" ng-controller="EditEnterprise"><br>
                            <div class="form-group">
                                <label class="control-label col-sm-5">Enterprise Name
                                    <input class="form-control" type="text" ng-model="name" ng-value="ent_name">
                                </label>
                                <label class="control-label col-sm-5">Enterprise Type
                                    <input class="form-control" type="text" ng-model="type" ng-value="ent_type">
                                </label>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-5">Enterprise Category
                                    <input class="form-control" type="text" ng-model="cat" ng-value="ent_cat" disabled>
                                </label>
                                <label class="control-label col-sm-3">Number of Employee
                                    <input class="form-control" type="number" min="1" ng-model="ent_no_emp" ng-value="no_emp">
                                </label>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-5">Address
                                    <input class="form-control" type="text" ng-model="address" ng-value="ent_add"></label>
                                
                                <label class="control-label col-sm-3">Contact Number
                                    <input class="form-control" type="text" ng-model="contact" ng-value="ent_contact">
                                </label>
                            </div>

                            <div class="form-group">
                                <label class="control-label col-sm-5">Enterprise Email
                                    <input class="form-control" type="text" ng-model="email" ng-value="ent_email">
                                </label>

                                <label class="control-label col-sm-5">Business Permit
                                    <input class="form-control" type="text" ng-model="permit" ng-value="ent_permit">
                                </label>
                            </div>

                            <div>
                                <label class="control-label col-sm-5">TIN No.
                                    <input class="form-control" type="text" ng-model="tin" ng-value="ent_tin">
                                </label>
                            </div>

                            <div class="form-group" style="margin-left: 15px;">
                                <button class="btn" ng-click="editEnterprise()" style="background-color: #ec4e20;color: white;">Update</button>

                                <a class="btn btn-danger" href="landing_account_enterprise.php">Cancel</a>
                            </div>    
                        </div>
    ...
    <script src="js_controller/get_edit_enterprise.js"></script>
