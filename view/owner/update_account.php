...
<body class="animsition">
                    ...
                    <div class="row">
                        <div class="container">
                            <div class="overview-wrap" style="border-bottom: 3px solid #ec4e20;">
                                <h3 class="title-1">Update Acoount</h3>
                            </div>
                        </div>
                    </div><br>
                    <div class="row" ng-controller="EditAccount">
                        <div class="container" style="background-color: #fefefe;"><br>
                            <form class="form-horizontal" >
                                
                                <div class="form-group">
                                    <label class="control-label col-sm-4">Email
                                        <input class="form-control" type="email" ng-model="edit_email" ng-value="acc_email">
                                    </label>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-4">Username
                                        <input class="form-control" type="text" ng-model="edit_username" ng-value="acc_username">
                                    </label>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-4">Password
                                        <input class="form-control" type="password" ng-model="edit_password" ng-value="acc_password">
                                    </label>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-4">Status
                                        <input class="form-control" type="text" ng-value="acc_status" ng-model="edit_status" disabled="">
                                    </label>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-4">User Type
                                        <input class="form-control" type="text" ng-value="acc_type" ng-model="edit_type" disabled="">
                                    </label>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm"> 
                                    <input class="btn" type="submit" ng-click="editAccount()" value="Update" style="background-color:#ec4e20;color: white;">   
   ...
   <!--  <script>
        $('#username1, #username2').on('keyup', function () {
        if ($('#username1').val() == $('#username2').val()) {
        $('#message').html('Username Match...').css('color', 'green');
        } else 
        $('#message').html('Username Does Not Match').css('color', 'red');
        });
    </script> -->
    ...
    <script src="js_controller/get_edit_account.js"></script>
</body>
</html>
<!-- end document-->