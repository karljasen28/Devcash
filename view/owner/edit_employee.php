...
<body class="animsition">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap" style="border-bottom: 3px solid #ec4e20;">
                                    <h3 class="title-1">Update Employee Info</h3>
                                </div>
                            </div>
                        </div><!-- END OF ROW --><br>
                        <div class="row">
                            <div class="container" ng-controller="EditEmployee">
                                <form class="form-horizontal">
                                    <div class="form-group">
                                        <img src="{{emp_pic}}" id="img-output" width="120" class="image img-cir">
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">Upload Image</label>
                                            <input class="form-control col-sm-4" type="file" id="pic" onchange="loadfile(event)">
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">Employee's First Name</label>
                                        <input class="form-control col-sm-5" type="text" placeholder="First Name" ng-model="edit_fname" ng-value="emp_fname" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">Employee's Last Name</label>
                                        <input class="form-control col-sm-5" type="text" placeholder="Last Name" ng-model="edit_lname" ng-value="emp_lname" disabled>
                                    </div>

                                    <!-- <div class="form-group">
                                        <label class="control-label">Email</label>
                                            <input class="form-control col-sm-5" type="email" placeholder="Email" ng-model="edit_email" ng-value="emp_email">
                                    </div> -->

                                    <div class="form-group">
                                        <label class="control-label">Contact No.</label>
                                            <input class="form-control col-sm-4" type="text" placeholder="Contact No." ng-model="edit_mobileno" ng-value="emp_mobileno">
                                    </div>

                                    <!-- <div class="form-group">
                                        <label class="control-label">Address</label>
                                            <input class="form-control col-sm-4" type="text" ng-model="edit_address" ng-value="emp_address">
                                    </div> -->

                                    <div class="form-group">
                                        <label class="control-label">Task</label>
                                            <select class="form-control col-sm-4" ng-model="edit_task">
                                                <option>Cashiering</option>
                                                <option>Inventory Monitoring</option>
                                            </select>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">Status</label>
                                            <select class="form-control col-sm-4" ng-model="edit_status">
                                    ...
                                    <div class="form-group">
                                        <input class="btn col-sm-2" type="submit" name="edit" value="Update" ng-click="editEmployee()" style="background-color: #ec4e20;color: white;">
                                        <a ng-click="back()" class="btn btn-danger col-sm-2" href="#">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script src="js_controller/get_edit_employee.js"></script>
</body>
</html>
<!-- end document-->